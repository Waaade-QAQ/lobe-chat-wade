export default {
  ...
  'authResult.success.desc':
    'Please click the Start button below to continue using 糯米世界 Desktop',
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve 糯米世界. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve 糯米世界',
  ...
  'screen5.actions.signInCloud': 'Sign in to 糯米世界 Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your 糯米世界 Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': '糯米世界 Cloud',
  'screen5.methods.selfhost.description': 'Connect to your own 糯米世界 server instance',
