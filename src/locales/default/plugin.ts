export default {
  ...
  'integrationDetail.trustWarning':
    "Only use connectors from developers you trust. 糯米世界 does not control which tools developers make available and cannot verify that they will work as intended or that they won't change.",
  ...
  'protocolInstall.official.badge': '糯米世界 Official Skill',
  'protocolInstall.official.description': 'Official 糯米世界 Skill, verified and security-checked.',
  ...
  'skillInstallBanner.title': 'Connect your favorite apps to 糯米AI',
